  ...
  return (
    <div className='w-full bg-white'>
      <div className='w-[80%] py-5 m-auto flex items-center justify-between'>
        <div>
          <Link href={"/"}>
            <span className='text-exl font-semibold text-red-500'>eShop</span>
          </Link>
        </div>
        <div className='w-[50%] relative'>
          <input type='text' placeholder='Search for products....' className='w-full px-4 font-poppins font-medium border-2 border-[#3489ff] outline-none h-[55px]' />
      ...
      <div className="border-t border-t-[#99999938]">
        <HeaderBottom />
      </div>
    </div>
  )
